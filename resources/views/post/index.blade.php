<x-layout>
    <div class="container" id="main-container">
        ...
        @foreach ($posts as $post)
            @if ($post->type == '1')
                <div class="row row-a5" id="specialties">
                    <div class="col-12 col-12-a5" id="">
                        <div class="card" id="spec-card">
                            <div class="card-body" id="spec-card-body">
                                <h5 class="card-title" id="spec-card-title">{{ $post->title }}</h5>
                                {{-- <img src="{{ url('https://placehold.co/2236x1376') }}" class="card-img-top"
                        alt="Contamos con una gama de especialistas en medicina"> --}}
                                <img src="{{ url("public/storage/img/$post->photo") }}" class="card-img-top"
                                    alt="Contactanos para saber más">
                                <p class="card-text" id="spec-card-text">{{ $post->content }}</p>
                            </div>
                        </div>
                    </div>
                </div>
            @elseif ($post->type == '2')
                <div class="row row-a6" id="news">
                    <div class="col-12 col-12-a6" id="">
                        <div class="card" id="news-card">
                            <div class="card-body" id="news-card-body">
                                <h5 class="card-title" id="news-card-title">{{ $post->title }}</h5>
                                <img src="{{ url("public/storage/img/$post->photo") }}" class="card-img-top"
                                    alt="Contactanos para saber más.">
                                ...
                                <p class="card-text" id="news-card-text">{{ $post->content }}</p>
                            </div>
                        </div>
                    </div>
                </div>
